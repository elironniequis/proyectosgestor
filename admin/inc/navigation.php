                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-header">Reportes</li>
                      ...
                      <li class="nav-item dropdown">
                        <a href="<?php echo base_url ?>admin/?page=reports/by_employee" class="nav-link nav-reports_by_employee">
                          <i class="nav-icon fas fa-circle"></i>
                          <p>
                            Reporte Tiempo Empleado
                          </p>
                        </a>
                      </li>
                      <li class="nav-item dropdown">
    ...
    $(document).ready(function(){
      ...
      $('#uni_modal').on('shown.bs.modal',function(){
        $('#find-transaction [name="tracking_code"]').focus();
			...
			uni_modal("Ingrese el número de seguimiento","transaction/find_transaction.php");
		})
    })
  </script>