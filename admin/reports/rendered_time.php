...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Informe de tiempo trabajado por proyecto</h3>
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					...
					<h3 class="text-center"><b>Reporte de tiempo trabajado por proyecto</b></h3>
					<h5 class="text-center"><b>a partir de</b></h5>
					<h5 class="text-center"><b><?= date("d/m/Y") ?></b></h5>
				</div>
				<div class="col-2"></div>
			</div>
...
<script>
	$(document).ready(function(){
       $('#print').click(function(){
		   ...
		   var _h = $('head').clone()
		   var _el = $('<div>')
		   _h.find("title").text("Reporte de Tiempo Trabajado - ConfiguroWeb")
